...
description: "Use when writing or running NRQL queries against New Relic for Adobe Commerce projects — logs, Fastly/CDN logs, transactions, APM errors, Redis, MySQL, Elasticsearch, or RabbitMQ data. Covers resolving project IDs to account IDs, per-entity WHERE filters, and mandatory field discovery."
---
