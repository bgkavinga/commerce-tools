...
description: "New Relic NRQL specialist for Adobe Commerce and general querying. Resolves Adobe Commerce project IDs to New Relic account IDs and runs NRQL queries against Log, Transaction, APM, Redis, MySQL, and Elasticsearch data."
---
